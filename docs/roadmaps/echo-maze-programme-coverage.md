...
| P2.4 | Echo Postcards with seed-only deterministic invitations | Partial | Current Development Roadmap P2 | #189; #190; #191 | P2.1/P2.2 | J | Seed contract, no identity/score/route/action leakage, desktop/mobile browser proof | PR pending; local gate and browser proof green | None |
