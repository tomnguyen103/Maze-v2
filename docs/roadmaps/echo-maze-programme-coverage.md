...
Status snapshot: 2026-08-02, `origin/main` includes merged PR #197 at
`618aba1` (PR #192 remains in its history at `2680874`).
...
| P0.3 | Honest release proof, operational/privacy/recovery documentation, and repo-controlled checks | Delivered (repo scope) | Current Development Roadmap P0.3 | Release-proof batch; #150/#151 evidence | P0.1/P0.2 | C | Updated ledger/status/evidence docs; local gate, bundle/function budgets, browser proof, live demo/readiness snapshot, and explicit external-boundary record | Reconciled on `origin/main` at `618aba1` | No live billing, production enforcement, irreversible migration, Stripe activation, production keys, or production-secret action without authorization |
| P1.1 | Echo Fossil Atlas for completed Labyrinth/Warden outcomes | Delivered | Current Development Roadmap P1 | #161-#165; ADR 0039 | P0.2 | D | Projection invariants, privacy/export/deletion, terminal player path, desktop/mobile/keyboard/reduced-motion coverage | PRs #163 (`b35a5eb`), #164 (`1c19b7a`), and #165 (`62eada5`) | None for repo work |
| P1.2 | Warden Tactics Lab with fixed unscored drills | Delivered | Current Development Roadmap P1 | #166-#173 | P1.1 | E | Deterministic drill coverage, no Quest/score/profile mutation, desktop/mobile browser proof | PR #174 (`fc43dc6`) | None |
| P1.3 | Reviewed Echo Lens explanation packs using visual primitives | Delivered | Current Development Roadmap P1; Next Expedition 9.5 | #175-#179 | P1.1 | F | Reviewed content coverage, revision binding, post-answer-only behavior, browser proof | PR #175 (`a175965`) | None |
| P1.4 | Quiet Expedition text/semantic, reduced-motion, keyboard, narration route | Delivered | Current Development Roadmap P1; Next Expedition 9.10/9.11 | #176-#180 | P1.1 | G | Nonvisual gameplay journey, semantic labels, reduced-motion and keyboard browser proof | PR #180 (`491a5f9`) | Human assistive-technology session remains external evidence |
| P2.1 | Transparent Trail Compass intention choice: Review, Explore, Challenge | Delivered | Current Development Roadmap P2; Next Expedition 9.10 | #181-#182 | P1.4 | H | Explicit choice only, no hidden adaptation, settings and gameplay browser proof | PR #182 (`1c99901`) | None |
| P2.2 | Classroom Expedition Debrief with aggregate teacher next steps and private student reflection | Delivered | Current Development Roadmap P2; Next Expedition 9.9 | #183-#184 | P1.2/P2.1 | I | Tenant/RLS/privacy thresholds, teacher/student desktop/mobile proof, export/deletion | PR #184 (`8265ba1`) | Live migrations/Stripe setup remain external |
| P2.3 | Privacy-reviewed Class Constellation only when the Daily aggregate gate is satisfied | Delivered | Current Development Roadmap P2; ADR 0043 | #185-#188 | P2.2; privacy review gate | I | Threshold/reconstruction tests, bounded Teacher reader, forming/band-only Classroom UI, desktop/mobile proof | PR #188 (`2b5bb57`) | Live migration 0029 and production configuration remain external |
| P2.4 | Echo Postcards with seed-only deterministic invitations | Delivered | Current Development Roadmap P2 | #189-#192 | P2.1/P2.2 | J | Seed contract, no identity/score/route/action leakage, desktop/mobile browser proof | PR #192 (`2680874`) | None for repo work |
| P3.1 | Quest II: Living Regions with five new arcs and unique reviewed content | Delivered | Current Development Roadmap P3 | #193-#197 (closed) | P1.1-P2.4 | K | Quest-wide map/question uniqueness, difficulty escalation, authored storylets, grey-box pacing, full browser/accessibility/content gates; PR #197's merged receipt was 1,474 passed / 18 skipped across 174 files and 246 passed / 22 skipped across 268 browser tests; the post-closeout test fix reran the same unit gate and passed 248 browser tests with 20 intentional skips and no failures | PR #197 merged as `618aba1`; closeout test fix delivered in PR #199 (head `57d32be`) | None for repo work; reviewed content is authored and committed, with no AI-generated content |
...
| Database migrations 0018-0029 | External pending | Authorized operator applies fresh migrations and runs smoke/integration checks |
