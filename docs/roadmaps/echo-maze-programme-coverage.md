...
Status snapshot: 2026-08-02, `origin/main` includes PR #192 at `2680874`
(PR #158 remains in its history at `69f4cd6`; Quest II PR #197 is still open).
...
| P3.1 | Quest II: Living Regions with five new arcs and unique reviewed content | In review | Current Development Roadmap P3 | #193-#197 | P1.1-P2.4 | K | Quest-wide map/question uniqueness, difficulty escalation, authored storylets, grey-box pacing, full browser/accessibility/content gates are green on PR #197; merge proof pending | PR #197 open at `bbcbf28` | Reviewed content authoring is repo-controlled; no AI-generated content |
